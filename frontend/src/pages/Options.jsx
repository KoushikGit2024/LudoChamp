                ...
                <div className="max-w-4xl mx-auto w-full">
                  <form onSubmit={handleRegister} className="grid grid-cols-1 md:grid-cols-2 gap-x-12 gap-y-8 pb-10 animate-in slide-in-from-right-4">
                    ...
                    <div className="space-y-6 flex flex-col justify-end">
                       ...
                       <button type="submit" disabled={loading || userStatus === 'taken' || isChecking} className="w-full py-4 mt-2 bg-[#00ff3c] text-black font-black uppercase text-[10px] tracking-widest rounded-xl hover:shadow-[0_0_20px_#00ff3c] transition-all disabled:opacity-30">{loading ? <Loader2 className="animate-spin mx-auto" size={16}/> : "INITIALIZE_PILOT_SEQUENCE"}</button>
                    </div>
                  </form>
                </div>
              )}
